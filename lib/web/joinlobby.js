        ...
        <div>
            ...
            <body>
                ...
                <p id="description">
                    ...
                    Once you enter a nickname and click submit, you can either look for a lobby that someone has create through a game id or create your own lobby. 
                ...
                <button 
                    ...
                    onClick = {() => {
                        ...
                        registerNickname(this.props.userName)
                        console.log(user_id)
